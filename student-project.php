                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                          <?php
                          $get_all_projects = "SELECT r.fname, r.lname, r.email, r.profile_pic, p.project_file, p.edited_count, p.username, p.is_approved FROM sms_projects AS p LEFT JOIN sms_registration AS r ON r.username = p.username ";
